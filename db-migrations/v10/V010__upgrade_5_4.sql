...
IF vulnerabilityId > 0 THEN
    ...
    UPDATE vulnerability SET description=p_description,
        ...
        v3AvailabilityImpact=p_v3AvailabilityImpact, v3BaseScore=p_v3BaseScore, v3BaseSeverity=p_v3BaseSeverity, v3Version=p_v3Version, v4version=p_v4version, v4attackVector=p_v4attackVector, v4attackComplexity=p_v4attackComplexity,
...
ELSE
    INSERT INTO vulnerability (cve, description, 
        ...
        p_v3BaseScore, p_v3BaseSeverity, p_v3Version, p_v4version, p_v4attackVector, p_v4attackComplexity, p_v4attackRequirements, p_v4privilegesRequired, 
